    ...
    <div class="col-lg-4">
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between mb-2">
                    <span class="text-muted">CGST ({{ ($invoice->gst_rate ?? 18) / 2 }}%)</span>
                ...
                <div class="d-flex justify-content-between mb-2">
                    <span class="text-muted">SGST ({{ ($invoice->gst_rate ?? 18) / 2 }}%)</span>
                ...
                <div class="d-flex justify-content-between mb-2">
                    <span class="text-muted">IGST ({{ $invoice->gst_rate ?? 18 }}%)</span>
